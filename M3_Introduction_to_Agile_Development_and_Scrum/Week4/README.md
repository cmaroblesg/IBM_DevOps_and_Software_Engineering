...
This optional Honors Project is highly recommended for learners who will be practitioners and are pursuing the [IBM DevOps and Software Engineering Professional Certificate.](https://www.coursera.org/professional-certificates/devops-and-software-engineering)  

If you choose to complete this final project, you will be awarded an Honors level certificate.  

In this project, you will create an Agile plan with ZenHub. You will write user stories, build and refine the product backlog, build a sprint plan, move stories on the kanban board, set up a burndown chart, and get ready for the next sprint.

## [Final Project Overview and Scenario](https://github.com/cmaroblesg/agile-final-project)
### OVERVIEW
